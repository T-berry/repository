# -*- coding: utf-8 -*-
"""
Created on Tue May  1 11:48:19 2018
...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['recover_l','recover_s','trend60','BollUp_turnover'
                    ,'BollDown_turnover','factor_PV', 'AD_close60','AD_hl60'
                    ,'r_adj80','pca','turnover_ratio','total_mv'
                    ,'tot_cur_assets']
...
import recover_l,recover_s,trend60,BollUp_turnover,BollDown_turnover,factor_PV,AD_close60,AD_hl60,r_adj80,pca

for f in ['recover_l','recover_s','trend60','BollUp_turnover','BollDown_turnover','factor_PV', 'AD_close60','AD_hl60','r_adj80','pca']:
