# -*- coding: utf-8 -*-
"""
Created on Sat Apr 28 12:15:43 2018
...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['alpha84','alpha88','alpha99','alpha133','Rstr504','GainVariance60','ARTDays','BollDown','acct_rcv','notes_rcv','adv_from_cust']
...
import alpha84,alpha88,alpha99,alpha133,Rstr504,GainVariance60,ARTDays,BollDown

for f in ['alpha84','alpha88','alpha99','alpha133','Rstr504','GainVariance60','ARTDays','BollDown']:
